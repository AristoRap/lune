module Lune
  module Native
    ...
    #   - mock/hotkeys.cr     HotkeysMock module
    #   - darwin/hotkeys.cr   LibNativeHotkeys (.m shim + Carbon)
    #   - linux/hotkeys.cr    LibX11Hotkeys
    #   - win32/hotkeys.cr    LibUser32Hotkeys (including Msg / PeekMessageW
    #                         reused by win32/tray.cr — Crystal would error
    #                         on a second declaration of those C symbols).
    module Hotkeys
      @@box : Void*? = nil
      @@started : Bool = false
