module Lune
  module Native
    ...
    {% elsif flag?(:win32) %}
      ...
      # LibUser32Tray reuses LibUser32Hotkeys::Msg / peek_message_w — Crystal's
      # `fun` system disallows two declarations of the same C symbol with
      # divergent types, and PeekMessageW was already declared in hotkeys.cr.
      # Window-class plumbing (register, create, dispatch) is unique to tray
      # and lives here.
      @[Link("user32")]
      lib LibUser32Tray
        WM_APP           = 0x8000_u32
        ...
        fun create_window_ex_w = CreateWindowExW(
          ...
          parent : Void*, menu : Void*, h_instance : Void*, lp_param : Void*) : Void*
